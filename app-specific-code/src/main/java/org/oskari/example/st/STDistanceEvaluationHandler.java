...
public class STDistanceEvaluationHandler extends RestActionHandler {
    ...
    public void handleGet(ActionParameters params) throws ActionException {
        ...
        try {
            ...
            UriComponentsBuilder uriBuilder = UriComponentsBuilder
                    .fromHttpUrl("http://" + stwsHost + ":" + stwsPort + "/distances_status/")
    ...
    public void handlePost(ActionParameters params) throws ActionException {
        ...
        try {
            ...
            errors.put(JSONHelper
                    .createJSONObject(Obj.writeValueAsString(new PostStatus("OK", "Distances evaluation started"))));
    ...
    protected void evaluateScenario(String user, String scenario) throws Exception {
        ...
        try {
            ...
            returns = restTemplate.postForObject("http://" + stwsHost + ":" + stwsPort + "/distances_evaluation/", map,
                    STDistanceExecution.class);
