package org.oskari.upt.helpers;
...
public class LayerHelper {
  ...
  private static boolean hasPermission(
    ...
    final String sql = "SELECT * FROM oskari_resource_permission WHERE external_type='ROLE' " +
  ...
  private static void addPermission(
      ...
      final String permission)
      throws SQLException {
    final String sql = "INSERT INTO oskari_resource_permission (external_type, permission, oskari_resource_id, external_id) VALUES (?,?,?,?)";
